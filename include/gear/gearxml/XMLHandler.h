...
namespace gear {
  ...
  /** Helper method used for parsing XML - returns the attribute 'value' of the 
      optional named child element as double
      returns the default value if the child element does not exist
   */
